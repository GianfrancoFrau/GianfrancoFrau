...
var es7_symbol_async_iterator = __webpack_require__(9665);
...
;// CONCATENATED MODULE: ./src/ts/icons.ts
var ICONS = ['las la-dragon', 'las la-coffee', 'las la-beer', 'las la-seedling', 'las la-robot', 'las la-tools', 'las la-terminal', 'las la-project-diagram', 'las la-sitemap', 'las la-flask', 'las la-laptop-code', 'las la-hat-wizard', 'las la-cog', 'las la-snowboarding', 'las la-otter', 'las la-hiking', 'las la-mountain', 'las la-magic', 'las la-brush', 'las la-theater-masks', 'las la-pizza-slice', 'las la-gamepad', 'las la-ghost', 'las la-cloud-moon', 'las la-dungeon', 'las la-sliders-h', 'las la-shipping-fast', 'las la-yin-yang', 'las la-brain', 'las la-rocket', 'las la-bug', 'las la-meteor', 'lab la-angular', 'lab la-linux', 'lab la-node-js', 'las la-fire-alt', 'las la-code', 'lab la-html5', 'lab la-css3-alt'];
...
var Utils = /*#__PURE__*/function () {
  ...
  _createClass(Utils, null, [{
    ...
    key: "onAnimationEnd",
    value: function onAnimationEnd(el) {
      return new Promise(function (resolve) {
...
function ts_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function ts_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }
function ts_createClass(Constructor, protoProps, staticProps) { if (protoProps) ts_defineProperties(Constructor.prototype, protoProps); if (staticProps) ts_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var App = /*#__PURE__*/function () {
  function App() {
    ts_classCallCheck(this, App);
    this.icons = [];
  }
  ts_createClass(App, [{
    key: "animateTitleIcon",
    value: function () {
      var _animateTitleIcon = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(loop) {
        var _this = this;
        var animated, animIndex, entranceAnim, exitAnim;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                animated = 'animate__animated';
                animIndex = 0; // Utils.getRandomInt(ANIMS.IN.length - 1);
                entranceAnim = ANIMS.IN[animIndex];
                exitAnim = ANIMS.OUT[animIndex];
                [animated, entranceAnim].map(function (c) {
                  return _this.titleIcon.classList.add(c);
                });
                _context.next = 7;
                return Utils.onAnimationEnd(this.titleIcon);
              case 7:
                _context.next = 9;
      ...
      function animateTitleIcon(_x) {
        return _animateTitleIcon.apply(this, arguments);
      }
      return animateTitleIcon;
    }()
  }, {
    key: "randomizeTitleIcon",
    value: function randomizeTitleIcon(animate) {
      var _this$titleIcon$class,
        _this2 = this;
      if (!this.icons.length) {
        this.icons = _toConsumableArray(ICONS);
      }
      if (!this.titleIcon) {
        this.titleIcon = document.querySelector('h2 .icons i');
      }
      var i = Utils.getRandomInt(this.icons.length - 1);
      var icon = this.icons[i];
      (_this$titleIcon$class = this.titleIcon.classList).remove.apply(_this$titleIcon$class, _toConsumableArray(Array.from(this.titleIcon.classList)));
      icon.split(' ').map(function (c) {
        return _this2.titleIcon.classList.add(c);
      });
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkgianfrancofrau_github_io"] = self["webpackChunkgianfrancofrau_github_io"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [80], () => (__webpack_require__(1504)))
